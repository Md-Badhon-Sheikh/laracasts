        ...
        <div class="my-10 px-20">
            <form action="{{route('store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex flex-col gap-4 border-2 border-green-600 py-3 px-8 rounded">
                    ...
                    <input type="email" value="{{old('name')}}" name="email" class="border-2 border-gray-300 py-2 px-2 rounded">
                    ...
                    <div>
                        <input type="submit" class="bg-green-700 text-white py-2 px-4 rounded font-semibold w-full mt-2">
                    </div>
